#!/bin/bash
# Постучите в бубен и помолитесь перед запуском данной программы! Она работает только тогда, когда хочется ей. И не питайте илюзий, что эта программа 
# решит ваши проблемы c гитхабом. Вы будете мучиться с ним вечно!
echo ""
